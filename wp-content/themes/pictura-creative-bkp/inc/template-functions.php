...
add_action( 'after_setup_theme', 'add_post_types' ); {
  ...
  function wpdocs_codex_FAQ_init() {
    $labels = array(
		'name' => _x( 'FAQ', 'Post type general name', 'pictura-creative' ),
      'singular_name' => _x( 'FAQ', 'Post type singular name', 'pictura-creative' ),
      'menu_name' => _x( 'FAQ', 'Admin Menu text', 'pictura-creative' ),
      'name_admin_bar' => _x( 'FAQ', 'Add New on Toolbar', 'pictura-creative' ),
      'add_new' => __( 'Add New', 'pictura-creative' ),
      'add_new_item' => __( 'Add New FAQ', 'pictura-creative' ),
      'new_item' => __( 'New FAQ', 'pictura-creative' ),
      'edit_item' => __( 'Edit FAQ', 'pictura-creative' ),
      'view_item' => __( 'View FAQ', 'pictura-creative' ),
      'all_items' => __( 'All FAQ', 'pictura-creative' ),
    );
