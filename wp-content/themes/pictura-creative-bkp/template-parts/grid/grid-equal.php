...
<section class="grid equal-section <?php echo $extraClass?>" style="background-color:<?php echo get_sub_field("background_color");?>" >
<div class="container">
    ...
    while ( have_rows( 'grid_content' ) ): the_row();?>
		<div class="col-sm-12 col-md-<?php echo $col;?>" >
