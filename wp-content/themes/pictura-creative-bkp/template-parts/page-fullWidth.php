...
if (have_rows('flexible_rows')):
...
} else if (get_row_layout() == 'flex_box_card') {

    echo get_template_part('template-parts/flex-img-txt-card/fleximgtxt', 'layout');
    ...
    echo get_template_part('template-parts/maps/map', 'emb');
