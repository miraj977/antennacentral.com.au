...
<section class="grid-text <?php echo $extraClass ?>"
    style="background-color:<?php echo get_sub_field("background_color"); ?>;text-align:<?php echo get_sub_field('align_content'); ?>">
