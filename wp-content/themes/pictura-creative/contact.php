        ...
        <div class="col-md-6 col-sm-12" data-aos="fade-up">
          <h4><?php echo get_field("contact_column_title"); ?></h4>
			<ul class="contact_info">
				...
				<li class="phoneIcon"><a href="tel:<?php echo get_field("phone","option");?>"><?php echo get_field("phone","option");?></a></li>
				<?php }?>
				
				<?php if(get_field("email","option")){
				$email = get_field("email","option");?>
				<li class="emailIcon"><a href="<?php echo obfuscate_email($email);?>"><?php echo $email;?></a></li>
				<?php }?>
				
				<?php if(get_field("address_1","option")){?>
				<li class="addressIcon"><?php echo get_field("address_1","option");?></li>
				<?php }?>
